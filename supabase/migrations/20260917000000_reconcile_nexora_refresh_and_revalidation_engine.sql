-- ==============================================================================
-- Migration: 20260917000000_reconcile_nexora_refresh_and_revalidation_engine.sql
-- Description: Forward-only production reconciliation for the missing/stale
--              effects of 20260903050000_nexora_refresh_and_revalidation_engine.sql.
-- Stage: 6C.1 — Production Federation Pilot Reconciliation
--
-- This migration intentionally restates only effects proven absent or stale in
-- hosted NEXORA production: six additive columns, two additive indexes, seven
-- service-role RPCs, and the latest service_get_federation_session definition.
-- It does not alter auth_operational_events or its telemetry metadata policy.
-- ==============================================================================
